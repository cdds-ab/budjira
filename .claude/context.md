...
|---------|-------|-----|--------------|
| **v1.30.0** | 2026-08-29 | feat | #123: `default_bucket` im Billing-Block — Precedence Issue→Label→Default→uncategorised; mit Default meldet `--validate` nur noch mehrdeutige Labels |
