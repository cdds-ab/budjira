...
This script provides a comprehensive overview at session start:
...
def main() -> int:
    ...
    print("=" * 70)
    print("🚀 budjira Development Session Start")
    print("=" * 70)
    print()
    ...
    if returncode == 0:
        ...
        print("⚠️  Unable to fetch issues (gh CLI not available or not authenticated)")
    print()
    ...
    if returncode == 0:
        ...
        print("⚠️  Unable to fetch releases")
    print()
    ...
    print("✓ Use TodoWrite tool to track feature development progress")
    print("✓ Update .claude/context.md before ending session")
